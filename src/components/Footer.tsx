...
export default function Footer() {
  ...
  const rawPhone = siteSettings?.whatsappNumber || '919876543210';
    ...
    <footer className="bg-white border-t border-gray-100 pt-16 pb-12 mt-auto relative">
      <div className="container mx-auto px-4 md:px-8">
        <div className="flex items-center gap-2 mb-8">
          <Link href="/" className="font-sans text-2xl font-black italic tracking-tighter text-charcoal flex items-baseline">
        ...
        <div className="flex gap-4 mb-12">
          ...
          <a 
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="w-10 h-10 rounded-full flex items-center justify-center shadow-sm hover:scale-110 transition-all text-white bg-[#25D366]"
          >
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-x-8 gap-y-12 mb-16">
          <div className="space-y-6">
            ...
            <ul className="space-y-4 text-sm text-gray-500">
              <li><Link href="/shop" className="hover:text-charcoal transition-colors cursor-pointer block">Shop All</Link></li>
              <li><Link href="/bats" className="hover:text-charcoal transition-colors cursor-pointer block">Handpicked Collection</Link></li>
              <li><a href={`https://wa.me/${phone}?text=Hello%20RJ%20Doctor%20Bat%2C%20I%20would%20like%20to%20track%20my%20recent%20order.`} target="_blank" rel="noopener noreferrer" className="hover:text-charcoal transition-colors cursor-pointer block">Track Order</a></li>
            </ul>
          </div>
          ...
          <div className="space-y-6">
            ...
            <ul className="space-y-4 text-sm text-gray-500">
              <li><a href={`https://wa.me/${phone}?text=Hello%20RJ%20Doctor%20Bat%2C%20I%20am%20facing%20an%20issue%20and%20need%20support.`} target="_blank" rel="noopener noreferrer" className="hover:text-charcoal transition-colors cursor-pointer block">Raise an Issue</a></li>
              <li><Link href="/repairs" className="hover:text-charcoal transition-colors cursor-pointer block">Repairs & Refurb</Link></li>
              <li><a href={`https://wa.me/${phone}?text=Hello%20RJ%20Doctor%20Bat%2C%20I%20have%20a%20query.`} target="_blank" rel="noopener noreferrer" className="hover:text-charcoal transition-colors cursor-pointer block">Contact Us</a></li>
            </ul>
          </div>
          ...
          <div className="space-y-6 col-span-2 md:col-span-1">
            ...
            <ul className="space-y-4 text-sm text-gray-500">
              <li>
                <Dialog>
                  <DialogTrigger className="hover:text-charcoal transition-colors cursor-pointer block text-left">Privacy Policy</DialogTrigger>
              ...
              <li>
                <Dialog>
                  <DialogTrigger className="hover:text-charcoal transition-colors cursor-pointer block text-left">Terms of Service</DialogTrigger>
                  <DialogContent className="max-w-3xl max-h-[85vh] overflow-y-auto">
                    <DialogHeader>
