      ...
      try {
        ...
        if (res.ok) {
          ...
          const mapped = data.map((item: any) => ({
            ...
            desc: "Expert repair service using premium materials.",
            image: item.imageReference || "/images/toe_repair.jpg"
          }));
          setServices(mapped);
        }
      } catch (error) {
      ...
      <div className="max-w-7xl mx-auto px-4 md:px-8 -mt-10">
        <div className="flex flex-col lg:flex-row gap-12 items-start">
          ...
          <div className="w-full lg:w-3/5 xl:w-2/3 bg-white p-6 md:p-8 rounded-2xl shadow-sm border border-gray-100">
            <VisualRepairMenu services={services} onSelect={(serviceName) => {
          ...
          <div id="booking-form" className="w-full lg:w-2/5 xl:w-1/3 lg:sticky lg:top-24">
            <RepairBookingForm services={services} selectedService={selectedService} />
          </div>
